...
from app.api.v1 import auth, users, routines, health, ingredients, exercises,diet, personal_data, training, log_exercises, physical, training_plan_history, physical_history, img_alimento ,hist_recetas,  img_maquinas, img_platos # Importar el nuevo módulo
