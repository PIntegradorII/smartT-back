...
from app.api.v1 import auth, users, routines, health, ingredients, exercises,diet, personal_data, training, log_exercises, physical, training_plan_history, physical_history, hist_recetas, img_alimento, img_maquinas, img_platos, barcode # Importar el nuevo módulo
...
app.include_router(img_alimento.router, prefix="/v1/img_alimento", tags=["img_alimento"])
